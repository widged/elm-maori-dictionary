...
/***/ function(module, exports) {
	...
	var _user$project$ItemList$renderItem = function (row) {
		return A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('mdl-card mdl-cell mdl-cell--12-col')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
	...
	var _user$project$ItemList$render = function (model) {
		return A3(
			_elm_lang$html$Html$node,
			'item-list',
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(_elm_lang$core$List$map, _user$project$ItemList$renderItem, model.items));
	};
	var _user$project$ItemList$initialModel = {
		items: _elm_lang$core$Native_List.fromArray(
			[])
	};
	var _user$project$ItemList$Item = F2(
		function (a, b) {
			return {word: a, definition: b};
		});
	var _user$project$ItemList$Model = function (a) {
		return {items: a};
	};
	var _user$project$ItemList$NoOp = {ctor: 'NoOp'};
	...
	var _user$project$LetterPicker$render = function (model) {
		var renderLetter = function (_p4) {
			...
			return A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('mdl-layout__tab'),
		...
		return A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('form-input'),
	...
	var _user$project$Main$initStore = {
		...
		eWordList: _user$project$ItemList$initialModel,
		letter: 'a',
		rows: _elm_lang$core$Native_List.fromArray(
			[])
	};
	var _user$project$Main$Store = F5(
		function (a, b, c, d, e) {
			return {eLetterPicker: a, eSearchBox: b, eWordList: c, letter: d, rows: e};
		});
	...
	var _user$project$Main$WordListMsg = F2(
		function (a, b) {
			return {ctor: 'WordListMsg', _0: a, _1: b};
		});
	...
	var _user$project$Main$update = F2(
		function (msg, store) {
			var log = A2(_elm_lang$core$Debug$log, 'msg', 'nothing');
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'SetRows':
					var _p1 = _p0._0;
				...
				case 'SearchBoxMsg':
					var _p5 = _p0._1;
					var _p2 = _p5;
					if (_p2.ctor === 'SearchWord') {
						var _p3 = _p2._0;
						var log = A2(_elm_lang$core$Debug$log, 'search', _p3);
						return {
							ctor: '_Tuple2',
							_0: store,
							_1: _user$project$Ports$wordChange(_p3)
						};
					} else {
						var log = A2(_elm_lang$core$Debug$log, 'box', _p5);
						var _p4 = A2(_user$project$SearchBox$update, _p5, store.eSearchBox);
						var newModel = _p4._0;
						var cmd = _p4._1;
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'LetterPickerMsg':
					var _p8 = _p0._1;
					var _p6 = _p8;
					if (_p6.ctor === 'SelectionChange') {
						...
						var log = A2(_elm_lang$core$Debug$log, 'pick', _p8);
						var _p7 = A2(_user$project$LetterPicker$update, _p8, store.eLetterPicker);
						var newModel = _p7._0;
						var cmd = _p7._1;
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
	...
	var _user$project$Main$view = function (store) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('mdl-layout mdl-js-layout mdl-layout--fixed-header')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('mdl-layout__header mdl-layout__header--scroll mdl-color--primary')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('mdl-layout--large-screen-only mdl-layout__header-row')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Maori Dictionary')
										]))
								])),
							A2(
							_elm_lang$html$Html$div,
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('picker')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('words mdl-layout__content')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('mdl-layout__tab-panel is-active')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
											_elm_lang$html$Html_App$map,
											_user$project$Main$WordListMsg('uid'),
